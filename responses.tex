...
\item Respond to \todo[inline]{It is quite surprising to me that there is only a \pounds 5K contribution in kind by the Met Office to the project and no project partner
contribution from ECMWF. If the work is so central to the development of the new dynamical core of these models one
would think that there would be a stronger in kind commitment. As a related comment, it would be helpful to have a clearer
description of the interface between the work the agencies are actively pursuing and the proposed work and why the
proposed work is needed but not a central plank of the new developments by the operational forecasters. The impact
statement was also less than convincing in this regard. There was no real strategy proposed which was surprising given
the stated importance to the agencies benefiting from the impact.}

This work is not a sub-contract from operational centres. We are exploring new, innovative approaches that could be too risky for an operational centre to commit significant resource to.
...
\item Respond to \todo[inline]{I find the 7 overseas conferences for a 3 year standard grant very excessive. It seems very difficult to me to justify this but
